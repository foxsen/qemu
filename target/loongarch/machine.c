...
const VMStateDescription vmstate_loongarch_cpu = {
    ...
    .fields = (VMStateField[]) {
        ...
        VMSTATE_UINT64(env.fpr[0].d, LoongArchCPU),
        VMSTATE_UINT64(env.fpr[1].d, LoongArchCPU),
        VMSTATE_UINT64(env.fpr[2].d, LoongArchCPU),
        VMSTATE_UINT64(env.fpr[3].d, LoongArchCPU),
        VMSTATE_UINT64(env.fpr[4].d, LoongArchCPU),
        VMSTATE_UINT64(env.fpr[5].d, LoongArchCPU),
        VMSTATE_UINT64(env.fpr[6].d, LoongArchCPU),
        VMSTATE_UINT64(env.fpr[7].d, LoongArchCPU),
        VMSTATE_UINT64(env.fpr[8].d, LoongArchCPU),
        VMSTATE_UINT64(env.fpr[9].d, LoongArchCPU),
        VMSTATE_UINT64(env.fpr[10].d, LoongArchCPU),
        VMSTATE_UINT64(env.fpr[11].d, LoongArchCPU),
        VMSTATE_UINT64(env.fpr[12].d, LoongArchCPU),
        VMSTATE_UINT64(env.fpr[13].d, LoongArchCPU),
        VMSTATE_UINT64(env.fpr[14].d, LoongArchCPU),
        VMSTATE_UINT64(env.fpr[15].d, LoongArchCPU),
        VMSTATE_UINT64(env.fpr[16].d, LoongArchCPU),
        VMSTATE_UINT64(env.fpr[17].d, LoongArchCPU),
        VMSTATE_UINT64(env.fpr[18].d, LoongArchCPU),
        VMSTATE_UINT64(env.fpr[19].d, LoongArchCPU),
        VMSTATE_UINT64(env.fpr[20].d, LoongArchCPU),
        VMSTATE_UINT64(env.fpr[21].d, LoongArchCPU),
        VMSTATE_UINT64(env.fpr[22].d, LoongArchCPU),
        VMSTATE_UINT64(env.fpr[23].d, LoongArchCPU),
        VMSTATE_UINT64(env.fpr[24].d, LoongArchCPU),
        VMSTATE_UINT64(env.fpr[25].d, LoongArchCPU),
        VMSTATE_UINT64(env.fpr[26].d, LoongArchCPU),
        VMSTATE_UINT64(env.fpr[27].d, LoongArchCPU),
        VMSTATE_UINT64(env.fpr[28].d, LoongArchCPU),
        VMSTATE_UINT64(env.fpr[29].d, LoongArchCPU),
        VMSTATE_UINT64(env.fpr[30].d, LoongArchCPU),
        VMSTATE_UINT64(env.fpr[31].d, LoongArchCPU),
